...
// ===== ASF Satellite Sites Nav (dropdown compacto, ao lado do menu principal) =====
(function(){
  function injectNav(){
    if(document.querySelector('.asf-sat-nav'))return;
    var sites=[["asf-praias","\u{1F3D6}\uFE0F Praias"],["asf-previsao","\u{1F30A} Previs\u00E3o"],["asf-mare","\u{1F319} Mar\u00E9"],["asf-mapa","\u{1F5FA}\uFE0F Mapa"],["asf-alerta","\u{1F6A8} Alerta"],["asf-sos","\u{1F198} SOS"],["asf-treino","\u{1F3CB}\uFE0F Treino"],["asf-manobras","\u{26A1} Manobras"],["asf-apnea","\u{1FAC1} Apneia"],["asf-respira","\u{1F32C}\uFE0F Respira"],["asf-yoga","\u{1F9D8} Yoga"],["asf-bemestar","\u{1F49A} Bem-Estar"],["asf-mental","\u{1F9E0} Mental"],["asf-nutricao","\u{1F957} Nutri\u00E7\u00E3o"],["asf-volume","\u{1F4D0} Volume"],["asf-equipamento","\u{1F3C4}\u200D\u2640\uFE0F Equipamento"],["asf-eventos","\u{1F4C5} Eventos"],["asf-glossario","\u{1F4D6} Gloss\u00E1rio"],["asf-historia","\u{1F4DC} Hist\u00F3ria"],["asf-kids","\u{1F9D2} Kids"],["asf-comunidade","\u{1F4AC} Comunidade"],["asf-parceiras","\u{1F91D} Parceiras"],["asf-carona","\u{1F697} Carona"],["asf-mercado","\u{1F6D2} Mercado"],["asf-viagens","\u{2708}\uFE0F Viagens"],["asf-galeria","\u{1F4F8} Galeria"],["asf-goldenhour","\u{1F305} Golden Hour"],["asf-quiz","\u{2753} Quiz"],["asf-ranking","\u{1F3C6} Ranking"],["asf-diario","\u{1F4D3} Di\u00E1rio"],["asf-eco","\u{1F331} Eco"],["asf-desafio","\u{1F3AF} Desafio"],["asf-leitura","\u{1F440} Leitura"],["asf-popup","\u{1F4E2} Popup"],["asf-ponto","\u{1F4CD} Ponto"],["asf-sonhos","\u{1F320} Sonhos"],["asf-clube","\u{1F4B3} Clube"],["asf-checklist","\u{2705} Checklist"],["asf-sono","\u{1F634} Sono"],["asf-inspiracao","\u{2728} Inspira\u00E7\u00E3o"],["asf-mentorias","\u{1F91D} Mentorias"]];
    var nav=document.createElement('nav');
    nav.className='asf-sat-nav';
    nav.setAttribute('aria-label','Apps ASF');
    nav.style.cssText='background:#fff;box-shadow:0 2px 6px rgba(0,0,0,.08);padding:.5rem 1rem;display:flex;align-items:center;gap:.6rem;position:sticky;top:0;z-index:10000;';
    var label=document.createElement('span');
    label.textContent='\u{1F4F1} Apps:';
    label.style.cssText='font-weight:700;font-size:.85rem;color:#0a4d68;white-space:nowrap;font-family:inherit;';
    var sel=document.createElement('select');
    sel.setAttribute('aria-label','Escolha um app ASF');
    sel.style.cssText='flex:1;min-width:0;max-width:340px;padding:.45rem .7rem;border-radius:999px;border:1px solid #088395;font-weight:600;font-size:.85rem;color:#0a4d68;background:#fff;cursor:pointer;font-family:inherit;';
    var ph=document.createElement('option');
    ph.value='';ph.textContent='Ver todos os apps ('+sites.length+')';ph.selected=true;
    sel.appendChild(ph);
    sites.forEach(function(s){
      var o=document.createElement('option');
      o.value='https://acarolmourad-commits.github.io/'+s[0]+'/';
      o.textContent=s[1];
      sel.appendChild(o);
    });
